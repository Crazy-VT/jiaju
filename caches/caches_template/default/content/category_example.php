        ...
        <div class="blog_section">
            ...
            <div class=" list_right">
                <div>
                    <h3>类别</h3>
                    <ul>
                        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=5b42a7c93225bb1977ff5a47737b0638&action=category&catid=%24CATEGORYS%5B%24catid%5D%5B%27catid%27%5D\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'category')) {$data = $content_tag->category(array('catid'=>$CATEGORYS[$catid]['catid'],'limit'=>'20',));}?>
                        <?php $n=1;if(is_array($data)) foreach($data AS $v) { ?>
